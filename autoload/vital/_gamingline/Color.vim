...
execute join(['function! vital#_gamingline#Color#import() abort', printf("return map({'xterm': '', 'hsl': '', 'rgb': '', 'parse': ''}, \"vital#_gamingline#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
